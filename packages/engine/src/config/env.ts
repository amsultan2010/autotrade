...
const schema = z.object({
  ...
  STRIPE_PRICE_PRO_LAUNCH: z.string().optional(),
  STRIPE_PRICE_UNLIMITED: z.string().optional(),
  STRIPE_PRICE_UNLIMITED_LAUNCH: z.string().optional(),
  STRIPE_PRICE_ELITE: z.string().optional(),
  CHECKOUT_SUCCESS_URL: z.string().default('http://localhost:3000/settings?billing=success'),
  CHECKOUT_CANCEL_URL: z.string().default('http://localhost:3000/settings?billing=cancel'),
