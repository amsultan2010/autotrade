...
export function OnboardingExperience() {
  ...
  const broker = useQuery(convexApi.brokerCredential.status);
  const completeOnboarding = useMutation(convexApi.users.completeAlpacaGuide);
  ...
  const alpaca = useAlpacaConnect(setError);
      ...
      <div className="onboarding-shell">
            ...
            <div className="onboarding-step onboarding-step--alpaca">
              ...
              <div className="onboarding-alpaca-layout">
                ...
                <div className="onboarding-alpaca-form panel">
                  ...
                  {broker?.connected ? (
                    <p className="muted">
                      Connected · {broker.paper ? 'Paper trading' : 'Live trading'}. You&apos;re all set.
                    </p>
                  ) : (
                    <>
                      ...
                      <label className="row gap" style={{ cursor: 'pointer', gap: '0.5rem', marginTop: '0.75rem' }}>
                        <input
                          type="checkbox"
                          checked={alpaca.paper}
                          onChange={(e) => alpaca.setPaper(e.target.checked)}
                        />
          ...
          {step === 3 && (
            <div className="onboarding-step onboarding-step--ready">
              ...
              <ul className="onboarding-checklist">
                ...
                {broker?.connected && <li>Alpaca paper account linked</li>}
              </ul>
            </div>
          )}
        </div>
        ...
        <footer className="onboarding-footer">
          ...
          <div className="onboarding-footer-right">
            ...
            {step === 2 && !broker?.connected && alpaca.keyId && alpaca.secret ? (
              <button
                type="button"
