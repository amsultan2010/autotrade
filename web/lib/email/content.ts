...
export const WEEKLY_DIGEST_ITEMS: DigestItem[] = [
  {
    ...
    body: 'Autotrade scans thousands of symbols around the clock — momentum shifts, volume spikes, and pattern breaks — then surfaces trades only when confidence clears your thresholds.',
    accent: '#00c896',
